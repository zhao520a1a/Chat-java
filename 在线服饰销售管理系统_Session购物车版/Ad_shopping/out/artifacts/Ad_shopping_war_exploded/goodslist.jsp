...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 商品列表</strong> <a href=""
                                                                               style="float:right; display:none;">添加字段</a>
        </div>
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li><a class="button border-main icon-plus-square-o" href="addgoods.jsp" > 添加商品</a></li>
                <%--  <li>搜索：</li>
                  <li>首页
        ...
        <table class="table table-hover text-center">
            ...
            <tr>
                ...
                <td><%=goods.getGoodsClass().getClassname()%>
                </td>
                <td width="10%"><img src="images/<%=goods.getImg()%>" alt="" width="70" height="50"/></td>
                ...
                <td><%=goods.getLeave_amount()%>
                </td>
                <td><%=goods.getProvider()%>
                </td>
                <td><%=goods.getContent()%>
                </td>
                <td><%=goods.getRegtime()%>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-main" href="updategoods.jsp" onclick="return showOneGoods(<%=goods.getGoodsId()%>)"><span
                            class="icon-edit"></span> 修改 </a>
                        <a class="button border-red" href="goodslist.jsp" onclick="return delGoods(<%=goods.getGoodsId()%>)"><span
