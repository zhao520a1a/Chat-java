    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div id="result" class="text-center" style="color:#ee3333;"  > </div>
                ...
                <div style="padding:30px;"><input type="button" onclick="verifyLogin()" class="button button-block bg-main text-big input-big" value="登录"></div>
            </div>
            </form>          
        </div>
    </div>
