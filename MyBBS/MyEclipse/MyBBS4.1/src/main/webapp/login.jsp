...
<div class="modal hide fade" id="login">
	<div class="modal-header">
		...
		<a href="javascript:void(0)" id="sticky_a"></a> <a
			...
			href="javascript:void(0)" id="sticky_a5"></a> <a
			href="javascript:void(0)" id="sticky_a6"></a> <a
			href="javascript:void(0)" id="sticky_a7"></a> <a
			href="javascript:void(0)" id="sticky_a8"></a> <a
			href="javascript:void(0)" id="sticky_a9"></a> <a
			href="javascript:void(0)" id="sticky_a10"></a>
	</div>
	<div class="modal-body" data-backdrop="static">
		<form method="post" action="UserControl" name="login_form"
			id="login_form">
