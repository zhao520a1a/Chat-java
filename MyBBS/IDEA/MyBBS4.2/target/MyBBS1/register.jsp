...
<div class="modal hide fade" id="register">
	...
	<div class="modal-body" data-backdrop="static">
		...
		<div class="cnt_b">
			<form action="UserControl" name="File_form"
				enctype="multipart/form-data" method="post" id="File_form">
				<div class="formRow">
							...
							<div class="controls">
								<div data-fileupload="image" class="fileupload fileupload-new">
									<div style="width: 60px; height: 60px;"
										...
										<img src="upload/cxy.jpg" name="portrait" id="portrait"
											alt="请选择自己的头像" />
									...
									<span class="btn btn-file"> <span class="fileupload-new">*选择头像</span>
										<span class="fileupload-exists">更换</span> <input type="file"
										id="file0" name="file0" class="uni_style" /> <strong>仅支持JPG、PNG、GIF、BMP格式.</strong>
									</span>
						...
						<div class="controls">
							<div class="alert alert-info">
								<label for="u_fname" class="control-label">注册账号</label> <input
									type="text" id="u_fname" name="reusername" class="input-xlarge"
									value="Kun Wei" /> <strong>账号*</strong> 请认真填写！
							</div>
					...
					<div class="control-group formSep">
						...
						<div class="controls">
							<div class="alert alert-info">
								...
								<div class="row-fluid">
									<div class="span10">
										<input type="password" placeholder="密码最少6位" class="span9"
											id="repassword" name="repassword" /> <strong>密码*</strong>最少6位，最大100位，请认真填写！
