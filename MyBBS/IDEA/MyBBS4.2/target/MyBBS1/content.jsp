...
<form name="addarticle" id="addarticle" action="ArticleControl"
	method="post">
	<table style="width: 500px; height: auto;">
		<tr>
			...
			<td><input type="text" value="" name="title" id="title"
				...
				<input type="hidden" name="userid" id="userid" value="${sessionScope.user.id}" /></td>
		
		</tr>
		<tr>
			<td valign="top">内容：</td>
			<td><textarea id="content" name="content" id="content" rows="5"
					cols="50"></textarea> <input type="hidden" id="neirong"
				name="neirong" value="123" /></td>
		</tr>
